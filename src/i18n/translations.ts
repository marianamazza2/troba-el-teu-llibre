...
const translations: Record<Language, Record<string, string>> = {
  cat: {
    ...
    follow_gate_title: 'Abans de continuar...',
    follow_gate_subtitle: 'Aquesta app és gratuïta. Si t\'ha sigut útil, segueix-nos a Instagram — ens ajuda moltíssim! 🙏',
    follow_gate_cta: 'Seguir a Instagram',
    follow_gate_followed: 'Gràcies! Continuar →',
    follow_gate_skip: 'Continuar sense seguir',
  ...
  es: {
    ...
    follow_gate_title: 'Antes de continuar...',
    follow_gate_subtitle: 'Esta app es gratuita. Si te ha sido útil, síguenos en Instagram — ¡nos ayuda muchísimo! 🙏',
    follow_gate_cta: 'Seguir en Instagram',
    follow_gate_followed: '¡Gracias! Continuar →',
    follow_gate_skip: 'Continuar sin seguir',
  ...
  en: {
    ...
    follow_gate_title: 'Before you continue...',
    follow_gate_subtitle: 'This app is free. If it helped you, follow us on Instagram — it means a lot! 🙏',
    follow_gate_cta: 'Follow on Instagram',
    follow_gate_followed: 'Thanks! Continue →',
    follow_gate_skip: 'Continue without following',
